...
Recommendations can be generated by any of four backends, selected with
`LLM_PROVIDER`. Everything else about the feature is identical — the same
prompt, the same output files.

| `LLM_PROVIDER` | Install | Credential | Default model |
| --- | --- | --- | --- |
| `openai` (default) | included | `GPT3_API_KEY` | `gpt-4.1-mini` |
